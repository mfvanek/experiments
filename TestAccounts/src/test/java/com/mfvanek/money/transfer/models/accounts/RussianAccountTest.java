...
class RussianAccountTest {
    ...
    @Test
    void getChapter() {
        RussianAccount account = RussianAccount.makeRouble(1L, "20202810100000000001", repository.getOurBank());
    ...
    @Test
    void getId() {
        RussianAccount account = RussianAccount.makeRouble(11L, "20202810100000000001", repository.getOurBank());
        assertNotNull(account);
    ...
    @Test
    void getNumber() {
        RussianAccount account = RussianAccount.makeRouble(1L, "30102810100000000001", repository.getOurBank());
        assertNotNull(account);
    ...
    void getCurrency() {
        RussianAccount account = RussianAccount.makeRouble(1L, "30102810100000000001", repository.getOurBank());
        assertNotNull(account);
        assertEquals(BaseCurrency.valueOf("RUB"), account.getCurrency());
    }
