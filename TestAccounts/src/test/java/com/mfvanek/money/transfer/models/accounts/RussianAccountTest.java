...
class RussianAccountTest {
    ...
    @Test
    void getChapter() {
        RussianAccount account = RussianAccount.newDefault(1L, "20202810100000000001", repository.getOurBank());
    ...
    @Test
    void getId() {
        RussianAccount account = RussianAccount.newDefault(11L, "20202810100000000001", repository.getOurBank());
        assertNotNull(account);
    ...
    @Test
    void getNumber() {
        RussianAccount account = RussianAccount.newDefault(1L, "30102810100000000001", repository.getOurBank());
        assertNotNull(account);
